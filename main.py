...
QUESTIONS_DATA = [
    ...
    # --- Bloco de perguntas do Colaborador (lógica corrigida) ---
    {"text": "1.1 (Colaborador) - Qual é a sua empresa?", "key_prefix": "c_q1_1_empresa", 'input_type': 'text', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    {"text": "1.2 (Colaborador) Em qual setor você atua?", "options": ["Silvicultura", "Colheita", "Administrativo", "Outro"], "key_prefix": "c_q1_2_setor", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    ...
    {"text": "2. (Colaborador) Você gostaria de informar o seu nome?", "options": ["Sim", "Não"], "key_prefix": "c_q2_informar_nome", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    ...
    {"text": "2.2 (Colaborador) Você quer receber o retorno do seu comunicado?", "options": ["Sim", "Não"], "key_prefix": "c_q2_2_retorno", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    ...
    {"text": "3. (Colaborador) O que você gostaria de comunicar?", "options": ["Reclamação", "Sugestão", "Elogio", "Engajamento", "Dúvida"], "key_prefix": "c_q3_tipo_comunicado", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    {"text": "3.1 (Colaborador) Por favor, descreva em detalhes a sua comunicação:", "key_prefix": "c_q3_1_descricao", 'input_type': 'text', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    {"text": "3.2 (Colaborador) Sua comunicação é algo recorrente?", "options": ["Sim", "Não"], "key_prefix": "c_q3_2_recorrente", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},
    {"text": "3.3 (Colaborador) Chegou a comunicar seu superior imediato?", "options": ["Sim", "Não"], "key_prefix": "c_q3_3_superior", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_values": ["Colaborador Interno - Colpar; RM ou Greenplac", "Colaborador externo - Prestador de Serviço"]}},

    # --- Início do Bloco Morador / Poder Público ---
    {"text": "S1.1 - A qual parte interessada você pertence?", "options": ["Local (vizinho)","Local (assentamento)","Local (município/cidade)","Tradicional","Indigena"], "key_prefix": "s_q1_1_parte_interessada", 'input_type': 'radio', "condition": {"depends_on_key": "q1_identificacao", "expected_value": "Morador Comunidade"}},
    {"text": "S1.2 - Digite o Nome da Comunidade/Localidade que você pertence:", "key_prefix": "s_q1_2_nome_comunidade", 'input_type': 'text', "condition": {"depends_on_key": "q1_identificacao", "expected_value": "Morador Comunidade"} },
    {"text": "S1.3 - A qual órgão do poder público você pertence?", "key_prefix": "s_q1_3_orgao_publico", 'input_type': 'text', "condition": {"depends_on_key": "q1_identificacao", "expected_value": "Poder Público"}},
...
if st.session_state.stage == "greeting":
    ...
    with st.container():
        ...
        if response_submitted and user_response is not None:
            ...
            if question_info["key_prefix"] == "c_q3_3_superior": force_final_prompt = True
